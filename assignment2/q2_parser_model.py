...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        U = tf.Variable(xavier_initializer((self.config.hidden_size,
            self.config.n_classes)))
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits_v2(logits=pred,
            labels=self.labels_placeholder), axis=0)
        ### END YOUR CODE
        return loss
